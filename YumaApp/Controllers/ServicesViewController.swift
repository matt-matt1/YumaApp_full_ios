...
class ServicesViewController: UIViewController
{
	...
	let cellID2 = "servicesCell2"
	var pageTitle: String = R.string.services
			...
			OperationQueue.main.addOperation
				{
					...
					self.pageControl.numberOfPages = self.store.services.count
					print("found \(self.store.services.count) products")
...
extension ServicesViewController: UICollectionViewDataSource, /*UICollectionViewDelegate,*/ UICollectionViewDelegateFlowLayout
{
	...
	{
		return self.store.services.count
	}
